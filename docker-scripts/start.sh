...
docker run --env-file /opt/sp-frontend-app-ecr/.env -dit -p 4000:4000 --restart on-failure:5 --name frontend 058264531795.dkr.ecr.us-east-1.amazonaws.com/sp-frontend-app-ecr:latest
